"""``sema <file>``, boot the workbench on a recording from the shell."""
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(prog="sema", description="Open an EEG/MEG recording in the Sema workbench.")
    ...
    try:
        ...
        print(f"sema: could not read {args.file!r}: {e}", file=sys.stderr)
        return 1
